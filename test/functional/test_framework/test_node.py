...
class TestNode():
    ...
    def __init__(
        ...
        *,
        ...
        # Previous release binaries still default to bitcoin.conf. Point them
        # at the configuration generated by the ReSatoshi test framework.
        if self.binaries.bin_dir is not None:
            self.args.append("-conf=resatoshi.conf")
