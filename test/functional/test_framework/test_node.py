...
BITCOIN_PID_FILENAME_DEFAULT = "resatoshid.pid"
...
class TestNode():
    ...
    def __init__(
        ...
        *,
        ...
        self.bitcoinconf = self.datadir_path / "resatoshi.conf"
        ...
        # Configuration for logging is set as command-line args rather than in the resatoshi.conf file.
    ...
    def start(self, extra_args=None, *, cwd=None, stdout=None, stderr=None, env=None, **kwargs):
        ...
        # resatoshi.conf. To avoid collisions, change it to 127.0.0.1:tor_port().
