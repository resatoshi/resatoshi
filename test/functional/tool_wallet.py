...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # `resatoshi-wallet help` raises an error. Use `resatoshi-wallet -help`.
        ...
        self.assert_raises_tool_error('No method provided. Run `resatoshi-wallet -help` for valid methods.')
