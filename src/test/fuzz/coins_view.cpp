    ...
    LIMITED_WHILE (good_data && fuzzed_data_provider.ConsumeBool(), 10'000) {
        CallOneOf(
            ...
            [&] {
                ...
                std::optional<CAmount> recycle_pool;
                RecycleExpiryChanges recycle_changes;
                auto cursor{CoinsViewCacheCursor(dirty_count, sentinel, coins_map, /*will_erase=*/true, recycle_pool, recycle_changes)};
