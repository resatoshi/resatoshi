...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    const std::string output_address{ReencodeBitcoinMainnetAddressForTest("3HqAe9LtNBjnsfM4CyYaWTnvCaUYT7v4oZ")};
    r = CallRPC(std::string("createrawtransaction ") + prevout + " {\"" + output_address + "\":11}");
...
BOOST_AUTO_TEST_CASE(help_example)
{
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", args), "> resatoshi-cli -named test foo=bar b=true n=1\n");
    ...
    // test shell escape
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b'ar"}}), "> resatoshi-cli -named test foo='b'''ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b\"ar"}}), "> resatoshi-cli -named test foo='b\"ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b ar"}}), "> resatoshi-cli -named test foo='b ar'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", obj_value}}), "> resatoshi-cli -named test name='{\"foo\":\"bar\",\"b\":false,\"n\":1}'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", arr_value}}), "> resatoshi-cli -named test name='[\"bar\",false,1]'\n");
