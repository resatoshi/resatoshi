...
/**
 * A UTXO expires when its age reaches this many blocks. Therefore, an output
 * is last spendable at age UTXO_EXPIRY_AGE - 1.
 *
 * Expiry enforcement and Recycle Pool accounting are implemented separately;
 * this constant records the agreed consensus boundary.
 */
static constexpr int UTXO_EXPIRY_AGE{5'256'000};
